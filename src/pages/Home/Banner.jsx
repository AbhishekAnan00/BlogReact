...
const Banner = () => {
  return (
    ...
    >
      ...
      <img src="https://techcrunch.com/wp-content/uploads/2022/05/GettyImages-1238043769.jpg?w=430&h=230&crop=1" className="absolute left-0 top-0 w-full h-full rounded z-0 object-cover" alt="First Example" />
      <div className="p-4 absolute bottom-0 left-0 z-20">
        ...
        <div className="flex mt-3">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-400 text-xs"> 14 Feb </p>
          </div>
        </div>
      </div>
    </a>
    ...
    >
      <div className="absolute left-0 top-0 w-full h-full z-10"
        style={{ backgroundImage: 'linear-gradient(180deg,transparent,rgba(0,0,0,.7))' }}></div>
      <img src="https://techcrunch.com/wp-content/uploads/2023/02/GettyImages-1242149379.jpg?w=430&h=230&crop=1" className="absolute left-0 top-0 w-full h-full rounded z-0 object-cover" alt="Second Example" />
      <div className="p-4 absolute bottom-0 left-0 z-20">
        ...
        <div className="flex mt-3">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-400 text-xs"> 28 Feb </p>
          </div>
        </div>
      </div>
    </a>
